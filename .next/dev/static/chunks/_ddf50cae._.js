...
function CreateMessage(t0) {
    ...
    if ($[0] !== "93696777328390283c0030a3dfe882d5499e399480356632537e5653732815a1") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "93696777328390283c0030a3dfe882d5499e399480356632537e5653732815a1";
    }
    const { note, mess } = t0;
    let t1;
    if ($[1] !== note.title) {
...
function NotesClient() {
    ...
    if ($[0] !== "3e499ad395923cd3813f84e0974285b3293030f481d66b3df3dee4868b784809") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3e499ad395923cd3813f84e0974285b3293030f481d66b3df3dee4868b784809";
    }
    ...
    const changeWord = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$debounce$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebouncedCallback"])(t4, 500);
    let t5;
    if ($[8] !== changeWord) {
...
//# sourceMappingURL=_ddf50cae._.js.map